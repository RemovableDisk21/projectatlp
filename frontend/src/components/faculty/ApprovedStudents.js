        ...
        faculty_HTMLTABLE = faculty.map( (item, index) => {
            return (
                <tr key={index}>
                    ...
                    <button onClick={(e) => update(e, item.id)} className="btn btn-success btn-sm">FAILED</button>
                    &nbsp;&nbsp;&nbsp;
                        <button type="button" onClick={(e) => deleteStudent(e, item.id)} className="btn btn-danger btn-sm">PASSED</button>
                    </td>

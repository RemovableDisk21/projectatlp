        ...
        faculty_HTMLTABLE = faculty.map( (item, index) => {
            return (
                <tr key={index}>
                    ...
                    <button onClick={(e) => update(e, item.id)} className="btn btn-success btn-sm">Edit</button>
                    &nbsp;&nbsp;&nbsp;
                    ...
                    <div className="col-md-12">
                        <div className="card">
                            <div className="card-header">
                                ...
                                <h4>Add Subject
                                <Link to="/faculty/dashboard" className="btn btn-primary btn-sm float-end"> Add Subject</Link>
                                </h4>
